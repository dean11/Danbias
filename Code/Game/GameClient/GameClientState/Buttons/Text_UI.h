...
namespace DanBias
{
	namespace Client
	{
		...
		public:
			...
			Text_UI(std::wstring text,  Oyster::Math::Float3 pos, Oyster::Math::Float2 size, Oyster::Math::Float fontSize = 0.5f, Oyster::Math::Float4 textColor =  Oyster::Math::Float4(1)) 
			...
			void RenderText() const
			{
				if(text.size() > 0)
				{
					Oyster::Graphics::API::RenderText(text, pos, size, size.y * fontSize, textColor);
				}
			}
